      ...
      <GameModeProvider>
        ...
        <div className="hidden 2xl:block">
          <div className="origin-top-left scale-[0.955]">
            <div className="grid grid-cols-[395px_237px_237px_237px_237px] gap-x-[39px] items-start">
              <div className="pl-0">
                <PanelProfileSummary
                  avatarSrc={profile.avatarSrc}
                  displayName={profile.displayName}
            ...
            <div className="mt-[54px] mb-6 grid grid-cols-[395px_237px_237px_237px_237px] gap-x-[39px]">
