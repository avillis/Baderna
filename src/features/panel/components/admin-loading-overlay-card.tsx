 ...
 * globalmente no app. A preferencia fica salva na API e vale pra todo mundo.
 */
  ...
  return (
    <aside className="rounded-[var(--panel-radius-card)] bg-white p-6 shadow-[0px_14px_50px_12px_rgba(0,0,0,0.05)]">
      ...
      <p className="mb-4 text-[12px] font-medium text-[#8d8d8d]">
        ...
        A preferencia fica salva globalmente e afeta todos os usuarios.
      </p>
      ...
      >
        {disabled
          ? "Reativar tela de carregamento"
          : "Desativar tela de carregamento"}
      </button>
