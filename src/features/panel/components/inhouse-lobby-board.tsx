  ...
  return (
    <section className="relative min-h-0 overflow-visible rounded-[36px] bg-transparent px-0 py-2 xl:min-h-[calc(100vh-120px)]">
      <div className="pointer-events-none absolute inset-0 z-0 hidden overflow-hidden rounded-[36px] xl:block">
        ...
        <div className="absolute top-[200px] left-1/2 h-[540px] w-[820px] -translate-x-[calc(50%+16px)] [mask-image:linear-gradient(to_right,transparent_0%,#000_12%,#000_88%,transparent_100%)] [mask-repeat:no-repeat] [mask-size:100%_220%] [mask-position:center] [-webkit-mask-image:linear-gradient(to_right,transparent_0%,#000_12%,#000_88%,transparent_100%)] [-webkit-mask-repeat:no-repeat] [-webkit-mask-size:100%_220%] [-webkit-mask-position:center]">
