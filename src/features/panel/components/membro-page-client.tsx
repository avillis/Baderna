  ...
  const editCardsButton = canEditModules ? (
    ...
    >
      ...
      >
        ...
        <path d="M8 16H9.67452C10.1637 16 10.4083 16 10.6385 15.9447C10.8425 15.8957 11.0376 15.8149 11.2166 15.7053C11.4184 15.5816 11.5914 15.4086 11.9373 15.0627L21.5 5.5C22.3284 4.67157 22.3284 3.32843 21.5 2.5C20.6716 1.67157 19.3284 1.67157 18.5 2.5L8.93723 12.0627C8.59133 12.4086 8.41838 12.5816 8.29469 12.7834C8.18504 12.9624 8.10423 13.1575 8.05523 13.3615C8 13.5917 8 13.8363 8 14.3255V16Z" />
      </svg>
      Editar cards
    </button>
  ) : null;
