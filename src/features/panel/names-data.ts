...
export const NAME_STYLES: NameStyle[] = [
  ...
  { id: "cafe",       label: "Café",     rarity: "comum", color: "#6f4e37" },
  { id: "mocha",      label: "Mocha",    rarity: "comum", color: "#967259" },
  { id: "caramelo",   label: "Caramelo", rarity: "comum", color: "#c68642" },
  { id: "tijolo",     label: "Tijolo",   rarity: "comum", color: "#cb6a51" },
  { id: "bege",       label: "Bege",     rarity: "comum", color: "#a08962" },
  { id: "aco",        label: "Aço",      rarity: "comum", color: "#5d6669" },
  { id: "mogno",      label: "Mogno",    rarity: "comum", color: "#4a0100" },
  { id: "cobre",      label: "Cobre",    rarity: "comum", color: "#b87333" },
  { id: "carvalho",   label: "Carvalho", rarity: "comum", color: "#5e4a1f" },
  { id: "noz",        label: "Noz",      rarity: "comum", color: "#5d3a1a" },
  { id: "ebano",      label: "Ébano",    rarity: "comum", color: "#3d2c1d" },
  { id: "tabaco",     label: "Tabaco",   rarity: "comum", color: "#9b6f4a" },
  ...
  { id: "solar",       label: "Solar",        rarity: "lendaria", className: "name-solar" },
  { id: "lunar",       label: "Lunar",        rarity: "lendaria", className: "name-lunar" },
  { id: "ember",       label: "Brasa",        rarity: "lendaria", className: "name-ember" },
  { id: "mercury",     label: "Mercúrio",     rarity: "lendaria", className: "name-mercury" },
  { id: "sakura-rain", label: "Sakura Rain",  rarity: "lendaria", className: "name-sakura-rain" },
  { id: "magnetic",    label: "Magnético",    rarity: "lendaria", className: "name-magnetic" },
